...
module.exports = {
     ...
     */
    and: function and(expressions, options) {
     ...
     * @param options OPTIONAL object. Any additional properties you want to add to the query (for example {boost:3})
     */
    or: function or(expressions, options) {
     ...
     * @param options OPTIONAL object. Any additional properties you want to add to the query (for example {boost:3})
     */
    not: function not(expression, options) {
     ...
     */
    range: function range(field, lowerBound, upperBound, options) {
        ...
        if (isUndefined(lowerBound)) {
            ...
            if ((typeof upperBound === 'undefined' ? 'undefined' : _typeof(upperBound)) !== (typeof lowerBound === 'undefined' ? 'undefined' : _typeof(lowerBound))) throw new Error('Both bounds must be same type!');
     ...
     */
    term: function term(value, field, options) {
     ...
     */
    near: function near(value, field, distance, options) {
        if (isUndefined(value)) throw new Error('Value must be defined');
     ...
     */
    phrase: function phrase(value, field, options) {
        if (isUndefined(value)) throw new Error('Value must be defined');
     ...
     */
    prefix: function prefix(value, field, options) {
        if (isUndefined(value)) throw new Error('Value must be defined');
